 ...
 *
 * <p>{@code FlutterActivityCompat} is the simplest and most direct way to integrate Flutter within an
 * Android app.
 *
 * <p><strong>FlutterActivityCompat responsibilities</strong>
 *
 * <p>{@code FlutterActivityCompat} maintains the following responsibilities:
 *
 * <ul>
 ...
 * the entrypoint that a {@code FlutterActivityCompat} executes, subclass {@code FlutterActivityCompat} and
 ...
 * controlled in a subclass of {@code FlutterActivityCompat} by overriding their respective methods:
 *
 * <ul>
 ...
 *
 * <p>{@code FlutterActivityCompat} can be used with a cached {@link
 * io.flutter.embedding.engine.FlutterEngine} instead of creating a new one. Use {@link
 * #withCachedEngine(String)} to build a {@code FlutterActivityCompat} {@code Intent} that is configured
 ...
 *
 * <ul>
 *   <li>When {@code FlutterActivityCompat} is the first {@code Activity} displayed by the app, because
 ...
 * }</pre>
 *
 * <p><strong>Alternatives to FlutterActivityCompat</strong>
 *
 ...
 *
 * <p>{@code FlutterActivityCompat} supports the display of an Android "launch screen" as well as a
 * Flutter-specific "splash screen". The launch screen is displayed while the Android application
 * loads. It is only applicable if {@code FlutterActivityCompat} is the first {@code Activity} displayed
 ...
 *
 * <p>In the AndroidManifest.xml, set the theme of {@code FlutterActivityCompat} to the defined launch
 * theme. In the metadata section for {@code FlutterActivityCompat}, defined the following reference to
 * your normal theme:
 *
 ...
 * the following metadata in AndroidManifest.xml for this {@code FlutterActivityCompat}:
 *
...
public class FlutterActivityCompat extends Activity
    ...
    /**
     * Creates an {@link Intent} that launches a {@code FlutterActivityCompat}, which creates a {@link
     ...
     * launch a {@code FlutterActivityCompat} that internally creates a new {@link
    ...
    public static NewEngineIntentBuilder withNewEngine() {
        return new NewEngineIntentBuilder(FlutterActivityCompat.class);
    }
    ...
    public static class NewEngineIntentBuilder {
         ...
         * with a {@code Class} reference to the {@code FlutterActivityCompat} subclass, e.g.:
         *
         * <p>{@code return new NewEngineIntentBuilder(MyFlutterActivityCompat.class); }
         */
        public NewEngineIntentBuilder(@NonNull Class<? extends FlutterActivityCompat> activityClass) {
     ...
     * to launch a {@code FlutterActivityCompat} that internally uses an existing {@link
    ...
    public static CachedEngineIntentBuilder withCachedEngine(@NonNull String cachedEngineId) {
        return new CachedEngineIntentBuilder(FlutterActivityCompat.class, cachedEngineId);
    }

    /**
     * Builder to create an {@code Intent} that launches a {@code FlutterActivityCompat} with an existing
    ...
    public static class CachedEngineIntentBuilder {
         ...
         *
         * <p>Subclasses of {@code FlutterActivityCompat} should provide their own static version of {@link
         * FlutterActivityCompat#withCachedEngine(String)}, which returns an instance of {@code
         * CachedEngineIntentBuilder} constructed with a {@code Class} reference to the {@code
         * FlutterActivityCompat} subclass, e.g.:
         *
         * <p>{@code return new CachedEngineIntentBuilder(MyFlutterActivityCompat.class, engineId); }
         *
         * @param activityClass A subclass of {@code FlutterActivityCompat}.
         * @param engineId      The engine id.
         */
        public CachedEngineIntentBuilder(
                @NonNull Class<? extends FlutterActivityCompat> activityClass, @NonNull String engineId) {
            this.activityClass = activityClass;
         ...
         * removed from the cache when this {@code FlutterActivityCompat} is destroyed.
         *
    ...
    // FlutterActivityCompat and FlutterFragment. See the FlutterActivityAndFragmentDelegateCompat
    // implementation for details about why it exists.
    @VisibleForTesting
    protected FlutterActivityAndFragmentDelegateCompat delegate;

    @NonNull
    private LifecycleRegistry lifecycle;

    public FlutterActivityCompat() {
     ...
     *
     * <p>The testing infrastructure should be upgraded to make FlutterActivityCompat tests easy to write
    ...
    @VisibleForTesting
    /* package */ void setDelegate(@NonNull FlutterActivityAndFragmentDelegateCompat delegate) {
     ...
     *   <li>In the AndroidManifest.xml, set the theme of your {@code FlutterActivityCompat} to your launch
     *       theme.
     *   <li>Add a {@code <meta-data>} property to your {@code FlutterActivityCompat} with a name of
    ...
    /**
     * {@link FlutterActivityAndFragmentDelegateCompat.Host} method that is used by {@link
     * FlutterActivityAndFragmentDelegateCompat} to obtain a {@code Context} reference as needed.
     */
    @Override
    @NonNull
    ...
    /**
     * {@link FlutterActivityAndFragmentDelegateCompat.Host} method that is used by {@link
     * FlutterActivityAndFragmentDelegateCompat} to obtain an {@code Activity} reference as needed. This
    ...
    /**
     * {@link FlutterActivityAndFragmentDelegateCompat.Host} method that is used by {@link
     * FlutterActivityAndFragmentDelegateCompat} to obtain a {@code Lifecycle} reference as needed. This
    ...
    /**
     * {@link FlutterActivityAndFragmentDelegateCompat.Host} method that is used by {@link
     * FlutterActivityAndFragmentDelegateCompat} to obtain Flutter shell arguments when initializing
     * Flutter.
     */
    @NonNull
    @Override
     ...
     * within this {@code FlutterActivityCompat}, or {@code null} if this {@code FlutterActivityCompat} does not
     ...
     * FlutterActivityCompat} should outlive this {@code FlutterActivityCompat}, or true to be destroyed when the
     * {@code FlutterActivityCompat} is destroyed.
     *
     * <p>The default value is {@code true} in cases where {@code FlutterActivityCompat} created its own
     ...
     * snapshots.
     *
     * <p>When this {@code FlutterActivityCompat} is run by Flutter tooling and a data String is included in
    ...
    /**
     * {@link FlutterActivityAndFragmentDelegateCompat.Host} method that is used by {@link
     * FlutterActivityAndFragmentDelegateCompat} to obtain the desired {@link RenderMode} that should be
    ...
    /**
     * {@link FlutterActivityAndFragmentDelegateCompat.Host} method that is used by {@link
     * FlutterActivityAndFragmentDelegateCompat} to obtain the desired {@link TransparencyMode} that should
     ...
     * io.flutter.embedding.engine.FlutterEngine} that is owned by this {@code FlutterActivityCompat}.
     *
    ...
    public void configureFlutterEngine(@NonNull FlutterEngine flutterEngine) {
        if (delegate.isFlutterEngineFromHost()) {
            // If the FlutterEngine was explicitly built and injected into this FlutterActivityCompat, the
     ...
     * FlutterActivityCompat} is being subclassed to utilize a custom and/or cached {@link
     * io.flutter.embedding.engine.FlutterEngine}.
     *
     ...
     * shouldAttachEngineToActivity} is true, then this {@code FlutterActivityCompat} will connect its
     ...
     * {@code FlutterActivityCompat} will not automatically manage the connection between its {@link
     ...
     * io.flutter.embedding.engine.FlutterEngine} from being attaching to a {@code FlutterActivityCompat} -
     * it just prevents the attachment from happening automatically. A developer can choose to
     * subclass {@code FlutterActivityCompat} and then invoke {@link
     ...
     * {@link io.flutter.embedding.engine.FlutterEngine} to outlive this {@code FlutterActivityCompat} so
     ...
     * FlutterActivityCompat} at an unusual time, preventing this {@code FlutterActivityCompat} from correctly
    ...
    private boolean stillAttachedForEvent(String event) {
        if (delegate == null) {
            Log.w(TAG, "FlutterActivityCompat " + hashCode() + " " + event + " called after release.");
            return false;
        }
        if (!delegate.isAttached()) {
            Log.w(TAG, "FlutterActivityCompat " + hashCode() + " " + event + " called after detach.");
            return false;
        }
        return true;
    }
